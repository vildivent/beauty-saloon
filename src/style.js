const style = {
  ...
  textMenu:
    "font-p leading-[130%] text-[18px] hover:text-[#CDAA7D] hover:border-b hover:border-[#CDAA7D]",
  grid: "list-none grid xl:grid-cols-3 md:grid-cols-2 grid-cols-1 xl:max-w-main md:max-w-md max-w-sm justify-center mx-auto",
};
